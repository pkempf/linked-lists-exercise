...
class LinkedList {
  ...
  setAt(idx, val) {
    if (this.length === 0 || idx < 0 || idx >= this.length) throw new Error("Index out of bounds");
  ...
  insertAt(idx, val) {
      ...
      else if (idx < 0 || idx > this.length) throw new Error("Index out of bounds");
      else {
  ...
  /** average(): return an average of all values in the list; returns 0 for 0-length list */
  ...
  /** _getNodeAt(idx): private helper; returns node at idx */
